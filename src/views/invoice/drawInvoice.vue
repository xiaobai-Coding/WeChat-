    ...
    <!-- <header> -->
      ...
      <div>
        <ul style="font-size: 1rem">
          <li style="width: 100%;float: left;color: #1aad19;font-size: 1.1rem;overflow: hidden;white-space: nowrap;text-overflow: ellipsis;">
            {{cardData.OrganName}}
          </li>
          <li style="width: 100px;float: left;font-size: 0.9rem">
            纳税人识别号
          </li>
          <li style="width: calc(100% - 100px);float: left;color: #333;font-size: 0.9rem">
            {{cardData.PayTaxNo}}
          </li>
          <li style="width: 100px;float: left;font-size: 0.9rem">
            联系电话
          ...
          <li style="width: calc(100% - 100px);float: left;color: #333;font-size: 0.9rem;text-overflow: -o-ellipsis-lastline;overflow: hidden;text-overflow: ellipsis;display: -webkit-box;-webkit-line-clamp: 2;line-clamp: 2;-webkit-box-orient: vertical;">
            {{cardData.PayAddress}}
          </li>
          <li style="width: 100px;float: left;font-size: 0.9rem">
            开户行
          </li>
          <li style="width: calc(100% - 100px);float: left;color: #333;font-size: 0.9rem;overflow: hidden;white-space: nowrap;text-overflow: ellipsis;">
            {{cardData.Bank}}
          </li>
        </ul>
        <p style="position: absolute;bottom: 20px;right: 20px;font-size: 1rem">
          <span>金额</span>
          <span style="color: red;"> {{this.$route.params.totalMoney}}元</span>
        </p>
      </div>
    </div> -->
    <!-- </header> -->
  ...
  methods: {
    ...
    submitFromData() {
      ...
      if(!this.submitData.OrganName){
        ...
        return false
      }else if(!this.submitData.PayTaxNo||this.submitData.PayTaxNo.trim().length<10){
